...
<body>
<!--头部左侧菜单开始-->
<%@ include file="/commons/pages/header.jsp" %>

<iframe frameborder=0 marginwidth=0 align=left
		id="mainFrame" name="mainFrame" height="600px;" width="100%"
		src="${ctx}/product/list" scrolling="auto">
</iframe>
